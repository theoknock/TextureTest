              ...
              )
{
    ...
    float grayscale = float(median3(gaussian_distribution(mean, standard_deviation, inputImageTexture.r),
                                    gaussian_distribution(mean, standard_deviation, inputImageTexture.g),
                                    gaussian_distribution(mean, standard_deviation, inputImageTexture.b)));
