                ...
                )
{
    ...
    half4 averageImageTextures  = ((inputImageTexture) + (inputImageTextureP)) * 0.5;
    half4 outputImageTexture = inputImageTexture * ( 1.0 - averageImageTextures); // (inputImageTextureP - inputImageTexture) * averageImageTextures;
