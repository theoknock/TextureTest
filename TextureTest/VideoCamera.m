...
static void(^captureDeviceConfigurationControlPropertyBlock_)(CaptureDeviceConfigurationControlProperty, float, UITouchPhase) = ^ (CaptureDeviceConfigurationControlProperty property, float value, UITouchPhase phase) {
...
+ (void(^)(CaptureDeviceConfigurationControlProperty, float, UITouchPhase))captureDeviceConfigurationControlPropertyBlock { return captureDeviceConfigurationControlPropertyBlock_; }
